...
@Data
@NoArgsConstructor
public class SocietyConfigHistoryDto extends BaseEntityDto implements Serializable {
	...
	@Builder
	public SocietyConfigHistoryDto(Long id, LocalDateTime created, String createdBy, LocalDateTime lastModified,
